...
class Google_Maps_Static extends Google_Maps_Overload
{
    ...
    *
    * @param string|string  $type   Either 'array' of 'string'.
    * @param bool|mixed     $bounds false or Google_Maps_Bounds
    *
